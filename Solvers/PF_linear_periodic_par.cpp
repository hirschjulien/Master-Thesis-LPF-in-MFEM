...
// ================= SETTING UP RHS FOR TIME INTEGRATION ==========
...
int main(int argc, char *argv[])
{
    ...
    // ========== MESH etc. (arranged like your parallel finite code) ============
    int order = 4;
    int ref_levels = 0;
    ...
    const char *mesh_file = "../Meshes/wave-tank.mesh";
        ...
        {
            return omega * 0 - k * (kx_dir * X(0) + ky_dir * X(1));
        };
    ...
    // ============== TIME INTEGRATION (no relaxation zones) =============
    //ODESolver *ode_solver = new RK4Solver();
