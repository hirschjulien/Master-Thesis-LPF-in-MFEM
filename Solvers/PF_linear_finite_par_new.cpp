...
// ====== NOT WORKING ======
// partial assembly of A with jacobi smoother

// ISSUE: The transition from generation zone to interior is not smooth, it is smooth when i am using HypreboomerAMG with CG
